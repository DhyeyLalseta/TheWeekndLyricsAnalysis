...
const App = () => {
  ...
  const onSubmitForm = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const {
        trilogyGeneratedText,
        modernGeneratedText,
      } = await response.json();
      updateTrilogyText(trilogyGeneratedText);
      updatePostKLText(modernGeneratedText);
    } catch (error) {
      console.error(error);
    }
  };
          ...
          <div className="col-sm">
            <div className="card text-left">
              <div className="card-body">
                <h5 className="card-title">Trilogy-Kiss Land generated text</h5>
